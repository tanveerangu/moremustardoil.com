...
@section('content')
    <div class="container-fluid">
        ...
        <form action="{{ route('admin.pages.multipleDelete') }}" method="POST" id="multiple-delete">
            @csrf
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h2 class="mb-0 float-start">{{ __('Pages') }}</h2>
                            <button type="submit" class="btn btn-danger float-end ms-2">
                                <i class="fa-solid fa-trash"></i> Delete Selected
                            </button>
                            <a href="{{ route('admin.pages.create') }}" class="btn btn-success float-end">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-danger delete-confirm"
                                                        data-url="{{ route('admin.pages.delete', $item->slug) }}">
